...
private:
  ...
  static double MASSCART;
  static double MASSPOLE_1;

  static double LENGTH_1;		  // actually half the pole's length

  static double FORCE_MAG;
  static double TAU;		  //seconds between state updates 

  static double one_degree;	// 2pi/360
  static double six_degrees;
  static double twelve_degrees;
  static double fifteen_degrees;
  static double thirty_six_degrees;
  static double fifty_degrees;
  */
  double LENGTH_2;
  double MASSPOLE_2;
  double MIN_INC;
